###########################################################################
## Makefile generated for Simulink model 'ActuatorLoop'. 
## 
## Makefile     : ActuatorLoop.mk
## Generated on : Wed May 13 13:31:50 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: .\ActuatorLoop_rtwlib.lib
...
COMPILER_COMMAND_FILE     = ActuatorLoop_comp.rsp
CMD_FILE                  = ActuatorLoop.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = ActuatorLoop_rtwlib.lib
...
PRODUCT = .\ActuatorLoop_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=ActuatorLoop -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\ert\ActuatorLoop\ActuatorLoop.c
...
{$(START_DIR)\slprj\ert\ActuatorLoop}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\ActuatorLoop}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
